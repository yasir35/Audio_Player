...
class PlaylistScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Playlist playlist = Playlist.playlists[playlistIndex];
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                _PlaylistAudios(playlist: playlist),
              ],
            ),
          ),
        ),
...
class _PlaylistAudios extends StatelessWidget {
  const _PlaylistAudios({
    Key? key,
    required this.playlist,
  }) : super(key: key);
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return ListTile(
          ...
          title: Text(
            playlist.audios[index].title,
            style: Theme.of(context)
                .textTheme
                .bodyLarge!
                .copyWith(fontWeight: FontWeight.bold),
          ),
          subtitle: Text('${playlist.audios[index].description} ⚬ 02:45'),
          trailing: const Icon(
            Icons.more_vert,
        ...
        child: Stack(
          children: [
            AnimatedPositioned(
              ...
              left: isPlay ? 0 : context.mediaQueryWidth * 0.45,
              child: Container(
                height: 50,
                    ...
                    children: [
                      Center(
                        child: Text(
                          'Play',
                          style: TextStyle(
                            color: isPlay ? kBackgroundColor : kDeepPurpleColor,
                            fontSize: 17,
                          ),
                        ),
                      ),
                    ...
                    children: [
                      Center(
                        child: Text(
                          'Shuffle',
                          style: TextStyle(
                            color: isPlay ? kDeepPurpleColor : kBackgroundColor,
                            fontSize: 17,
                          ),
                        ),
                      ),
